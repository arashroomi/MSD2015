...
#include <stddef.h>
#include "blas.h"
#include "test_lineestimator_simulinkV1803_sfun.h"
#include "c3_test_lineestimator_simulinkV1803.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "test_lineestimator_simulinkV1803_sfun_debug_macros.h"
...
static const char * c3_debug_family_names[37] = { "Vision", "X_Vision",
  "Y_Vision", "Lvision", "init_angel", "X", "Y", "theta1", "theta2", "theta3",
  "theta4", "rho1", "rho2", "rho3", "rho4", "X1", "Y1", "rho11", "rho21",
  "rho31", "rho41", "Lines", "B", "k", "i", "rho", "theta", "nargin", "nargout",
  "H", "thetaCam", "X_in", "Y_in", "psi", "Field_length", "Field_width",
  "CompMatrix" };

/* Function Declarations */
static void initialize_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void initialize_params_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void enable_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void disable_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void set_sim_state_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance, const
   mxArray *c3_st);
static void finalize_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void sf_gateway_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void mdl_start_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void c3_chartstep_c3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
static void initSimStructsc3_test_lineestimator_simulinkV1803
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance);
...
static real_T c3_mpower(SFc3_test_lineestimator_simulinkV1803InstanceStruct
  *chartInstance, real_T c3_a);
static void c3_eml_scalar_eg(SFc3_test_lineestimator_simulinkV1803InstanceStruct
  *chartInstance);
static real_T c3_sqrt(SFc3_test_lineestimator_simulinkV1803InstanceStruct
                      *chartInstance, real_T c3_x);
static void c3_eml_error(SFc3_test_lineestimator_simulinkV1803InstanceStruct
  *chartInstance);
static real_T c3_abs(SFc3_test_lineestimator_simulinkV1803InstanceStruct
                     *chartInstance, real_T c3_x);
...
static uint8_T c3_f_emlrt_marshallIn
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance, const
   mxArray *c3_b_is_active_c3_test_lineestimator_simulinkV1803, const char_T
   *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance, const
   mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sqrt(SFc3_test_lineestimator_simulinkV1803InstanceStruct
                      *chartInstance, real_T *c3_x);
  ...
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_test_lineestimator_simulinkV1803 = 0U;
}
  ...
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal =
    chartInstance->c3_is_active_c3_test_lineestimator_simulinkV1803;
   ...
   mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_test_lineestimator_simulinkV1803 =
    c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "is_active_c3_test_lineestimator_simulinkV1803");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_test_lineestimator_simulinkV1803(chartInstance);
  ...
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_test_lineestimator_simulinkV1803(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_test_lineestimator_simulinkV1803MachineNumber_, chartInstance->chartNumber,
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Field_length, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_Field_width, 7U);
}
  ...
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance)
{
  ...
  real_T c3_b_Y_in;
  real_T c3_b_psi;
  real_T c3_b_Field_length;
  real_T c3_b_Field_width;
  uint32_T c3_debug_family_var_map[37];
  real_T c3_Vision;
  real_T c3_X_Vision;
  real_T c3_Y_Vision;
  real_T c3_Lvision;
  real_T c3_init_angel;
  real_T c3_X;
  real_T c3_Y;
  real_T c3_theta1;
  real_T c3_theta2;
  ...
  c3_f_hoistedGlobal = *chartInstance->c3_Field_length;
  c3_g_hoistedGlobal = *chartInstance->c3_Field_width;
  ...
  c3_b_Field_length = c3_f_hoistedGlobal;
  c3_b_Field_width = c3_g_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 37U, 37U, c3_debug_family_names,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Y_Vision, 2U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Lvision, 3U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_init_angel, 4U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_X, 5U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_Y, 6U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_Field_length, 34U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_Field_width, 35U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_CompMatrix, 36U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_Vision = 2.0 * c3_b_H * c3_e_x;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 15);
  c3_X_Vision = c3_Vision;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 16);
  c3_Y_Vision = c3_Vision * 0.75;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 18);
  c3_d0 = c3_mpower(chartInstance, c3_X_Vision) + c3_mpower(chartInstance,
    c3_Y_Vision);
  c3_b_sqrt(chartInstance, &c3_d0);
  c3_Lvision = c3_d0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 19);
  c3_init_angel = 0.92729521800161219;
  ...
  c3_h_x = c3_g_x;
  c3_b_y = c3_h_x / 2.0;
  c3_i_x = c3_init_angel - c3_b_psi;
  c3_j_x = c3_i_x;
  c3_j_x = muDoubleScalarSin(c3_j_x);
  c3_X = c3_b_X_in - c3_b_y * c3_j_x;
  ...
  c3_m_x = c3_l_x;
  c3_c_y = c3_m_x / 2.0;
  c3_n_x = c3_init_angel - c3_b_psi;
  c3_o_x = c3_n_x;
  c3_o_x = muDoubleScalarCos(c3_o_x);
  c3_Y = c3_b_Y_in + c3_c_y * c3_o_x;
  ...
  c3_d_A = c3_b_Field_length;
  c3_p_x = c3_d_A;
  c3_q_x = c3_p_x;
  c3_r_x = c3_q_x;
  c3_d_y = c3_r_x / 2.0;
  c3_rho1 = c3_abs(chartInstance, c3_X + c3_d_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 35);
  c3_e_A = c3_b_Field_width;
  c3_s_x = c3_e_A;
  c3_t_x = c3_s_x;
  c3_u_x = c3_t_x;
  c3_e_y = c3_u_x / 2.0;
  c3_rho2 = c3_abs(chartInstance, -c3_Y + c3_e_y);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 36);
  c3_f_A = c3_b_Field_length;
  c3_v_x = c3_f_A;
  c3_w_x = c3_v_x;
  c3_x_x = c3_w_x;
  c3_f_y = c3_x_x / 2.0;
  c3_y_x = -c3_X + c3_f_y;
  c3_ab_x = c3_y_x;
  c3_rho3 = muDoubleScalarAbs(c3_ab_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 37);
  c3_g_A = c3_b_Field_width;
  c3_bb_x = c3_g_A;
  c3_cb_x = c3_bb_x;
  c3_db_x = c3_cb_x;
  c3_g_y = c3_db_x / 2.0;
  c3_eb_x = c3_Y + c3_g_y;
  c3_fb_x = c3_eb_x;
  c3_rho4 = muDoubleScalarAbs(c3_fb_x);
  ...
  c3_ib_x = c3_hb_x;
  c3_h_y = c3_ib_x / 2.0;
  c3_jb_x = c3_X1 + c3_h_y;
  c3_kb_x = c3_jb_x;
  c3_rho11 = muDoubleScalarAbs(c3_kb_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 43);
  c3_i_A = c3_b_Field_width;
  c3_lb_x = c3_i_A;
  c3_mb_x = c3_lb_x;
  c3_nb_x = c3_mb_x;
  c3_i_y = c3_nb_x / 2.0;
  ...
  c3_j_A = c3_b_Field_length;
  c3_qb_x = c3_j_A;
  c3_rb_x = c3_qb_x;
  c3_sb_x = c3_rb_x;
  c3_j_y = c3_sb_x / 2.0;
  c3_tb_x = -c3_X1 + c3_j_y;
  c3_ub_x = c3_tb_x;
  c3_rho31 = muDoubleScalarAbs(c3_ub_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 45);
  c3_k_A = c3_b_Field_width;
  c3_vb_x = c3_k_A;
  c3_wb_x = c3_vb_x;
  c3_xb_x = c3_wb_x;
  c3_k_y = c3_xb_x / 2.0;
  c3_yb_x = c3_Y1 + c3_k_y;
  c3_ac_x = c3_yb_x;
  c3_rho41 = muDoubleScalarAbs(c3_ac_x);
  ...
  while (c3_b_k < 4) {
    ...
    c3_d1 = c3_Lines[_SFD_EML_ARRAY_BOUNDS_CHECK("Lines", (int32_T)
      _SFD_INTEGER_CHECK("k", c3_k), 1, 4, 1, 0) + 7];
    if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c3_d1, c3_X_Vision, -1,
          2U, c3_d1 < c3_X_Vision))) {
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance;
  chartInstance = (SFc3_test_lineestimator_simulinkV1803InstanceStruct *)
    chartInstanceVoid;
  ...
  *sf_c3_test_lineestimator_simulinkV1803_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 34, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("sqrt"), "name", "name", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 22);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("atan"), "name", "name", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286818718U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("sin"), "name", "name", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("cos"), "name", "name", 29);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
   ...
   *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_test_lineestimator_simulinkV1803), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_test_lineestimator_simulinkV1803);
  return c3_y;
}
  ...
  (SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_psi = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c3_Field_length = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c3_Field_width = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 6);
}
...
mxArray *sf_c3_test_lineestimator_simulinkV1803_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_test_lineestimator_simulinkV1803_get_post_codegen_info();
...
mxArray *sf_c3_test_lineestimator_simulinkV1803_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_test_lineestimator_simulinkV1803_jit_fallback_info(void)
{
...
mxArray *sf_c3_test_lineestimator_simulinkV1803_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_test_lineestimator_simulinkV1803
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"CompMatrix\",},{M[8],M[0],T\"is_active_c3_test_lineestimator_simulinkV1803\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_test_lineestimator_simulinkV1803_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _test_lineestimator_simulinkV1803MachineNumber_,
           3,
           1,
           1,
           0,
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(6,1,1,0,"Field_length");
          _SFD_SET_DATA_PROPS(7,1,1,0,"Field_width");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2348);
        _SFD_CV_INIT_EML_IF(0,1,0,2100,2122,-1,2153);
        _SFD_CV_INIT_EML_IF(0,1,1,2158,2174,-1,2209);
        _SFD_CV_INIT_EML_IF(0,1,2,2214,2224,-1,2258);
        _SFD_CV_INIT_EML_FOR(0,1,0,1969,1979,2292);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,2103,2122,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,2161,2174,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,2217,2224,-1,2);
        ...
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c3_Field_length);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c3_Field_width);
      }
    } else {
  ...
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
  initialize_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_test_lineestimator_simulinkV1803(void
  *chartInstanceVar)
{
  enable_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_test_lineestimator_simulinkV1803(void
  *chartInstanceVar)
{
  disable_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_test_lineestimator_simulinkV1803(void
  *chartInstanceVar)
{
  sf_gateway_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c3_test_lineestimator_simulinkV1803(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_test_lineestimator_simulinkV1803
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_test_lineestimator_simulinkV1803(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_test_lineestimator_simulinkV1803_optimization_info();
    }

    finalize_c3_test_lineestimator_simulinkV1803
      ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_test_lineestimator_simulinkV1803
    ((SFc3_test_lineestimator_simulinkV1803InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_test_lineestimator_simulinkV1803(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_test_lineestimator_simulinkV1803(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_test_lineestimator_simulinkV1803_optimization_info();
...
static void mdlRTW_c3_test_lineestimator_simulinkV1803(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_test_lineestimator_simulinkV1803(SimStruct *S)
{
  SFc3_test_lineestimator_simulinkV1803InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_test_lineestimator_simulinkV1803InstanceStruct *)
    utMalloc(sizeof(SFc3_test_lineestimator_simulinkV1803InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_test_lineestimator_simulinkV1803;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_test_lineestimator_simulinkV1803;
...
void c3_test_lineestimator_simulinkV1803_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_test_lineestimator_simulinkV1803(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_test_lineestimator_simulinkV1803(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_test_lineestimator_simulinkV1803(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_test_lineestimator_simulinkV1803_method_dispatcher.\n"
